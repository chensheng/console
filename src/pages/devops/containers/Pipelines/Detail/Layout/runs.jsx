...
export default class RunDetailLayout extends React.Component {
  ...
  render() {
    ...
    let breadcrumbsLabel = branch ? (runId ? t('Activity') : t('Branch')) : t('Activity')
    let breadcrumbsUrl = branch ? `${this.listUrl}/${name}/branch/${branch}/activity` : `${this.listUrl}/${name}/activity`
