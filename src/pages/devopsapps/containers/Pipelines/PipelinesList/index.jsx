...
import { withDevOpsAppList, ListPage } from 'components/HOCs/withList'
...
export default class PipelinesList extends React.Component {
  constructor(props) {
    ...
    this.formTemplate = {
      devopsappName: this.devopsappName,
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (params.devopsapp !== nextParams.devopsapp) {
  ...
  get devopsappName() {
    return this.props.devopsappStore.devopsappName
  }
  ...
  getCRDDetail = async name => {
    ...
    formData.devopsapp = this.devopsapp
    formData.cluster = this.cluster
    formData.devopsappName = this.devopsappName
